const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Masterportal-DnbiQfT0.js","assets/vendor-react-BFXNeceC.js","assets/vendor-react-dom-DDWplefk.js","assets/vendor-DDAwBBib.js","assets/CreateAccount-CMQDWHsO.js","assets/ViewAccounts-COfZN4vD.js","assets/GeneralJournalEntry-COzy8fNI.js","assets/JournalTopNav-BlpLUyTY.js","assets/ViewGeneralEntries-CETpwRkl.js","assets/InoviceDashboard-DrhdVA2r.js","assets/SalesInvoice-DGqbaeYd.js","assets/PurchaseInvoiceForm-8BuLzZbC.js","assets/PurchaseQuotation-B6mrW65Z.js","assets/ViewSalesInvoices-CjIs1opb.js","assets/ViewPurchaseInvoices-CR1NC5er.js","assets/AccountsPage-Bc8B1IS3.js","assets/LedgerSearch-6KmvMMPF.js","assets/LedgerByReference-BZSrn0JA.js","assets/LedgerByAccount-CvX66FT3.js","assets/ProductsList-DEQgfzOH.js","assets/BalanceSheet-TYO3eYh8.js","assets/TrialBalance-B9YBQ4DM.js","assets/IncomeStatement-DSRy3mXL.js","assets/CreateEmployee-CqXW4Xgc.js","assets/ViewEmployees-GwzSzJpB.js","assets/WeightBridge-BxrMAwHy.js","assets/WeightBridgeInvoice-D59kszz8.js","assets/CashbookForm-sRVVVz_c.js","assets/CashbookReport-B9oHWYkh.js","assets/CreateChequeBook-BFzTIUuk.js","assets/ChequeTopNav-BwrjA0ks.js","assets/CreateChequeEntry-DcgAVqIv.js","assets/ViewChequeBooks-D-xINCAh.js","assets/Adminprofile-LnGMZ6ZZ.js","assets/Stockmanagement-DaH2D2YV.js"])))=>i.map(i=>d[i]);
import{j as e,a as r,u as ce,N as ge,b as We,R as se,L as be,B as ot,d as st,e as m}from"./vendor-react-BFXNeceC.js";import{c as nt}from"./vendor-react-dom-DDWplefk.js";import{_ as y}from"./vendor-DDAwBBib.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&a(h)}).observe(document,{childList:!0,subtree:!0});function n(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function a(i){if(i.ep)return;i.ep=!0;const c=n(i);fetch(i.href,c)}})();const rt=({show:o=!0,message:s})=>o?e.jsxs("div",{className:"fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-white/95 backdrop-blur-sm","aria-live":"polite","aria-busy":"true",role:"status",children:[e.jsx("div",{className:"loader-pulse flex items-center justify-center",children:e.jsx("img",{src:"/logo.png",alt:"",className:"loader-spin h-20 w-20 object-contain sm:h-24 sm:w-24",width:96,height:96})}),s&&e.jsx("p",{className:"mt-4 text-sm font-medium text-gray-600",children:s}),e.jsx("span",{className:"sr-only",children:"Loading…"})]}):null,at=r.createContext(null);function it({children:o}){const[s,n]=r.useState(!1),[a,i]=r.useState(""),c=r.useCallback((h,f="")=>{n(!!h),i(f||"")},[]);return e.jsxs(at.Provider,{value:{loading:s,setLoading:c,message:a},children:[o,e.jsx(rt,{show:s,message:a})]})}function x({children:o}){const s=localStorage.getItem("token"),n=ce();if(!s)return e.jsx(ge,{to:"/",replace:!0});let a=[];try{a=JSON.parse(localStorage.getItem("allowedRoutes"))||[]}catch{a=[]}if(!a.length||a.includes("*"))return o;const i=n.pathname;return a.some(h=>{if(h===i||h.endsWith("/*")&&i.startsWith(h.replace("/*","")))return!0;const f=h.split("/"),j=i.split("/");return f.length!==j.length?!1:f.every((N,S)=>N.startsWith(":")||N===j[S])})?o:e.jsx(ge,{to:"/dashboard",replace:!0})}const q="/api";if(typeof document<"u"&&!document.getElementById("ntf-css")){const o=document.createElement("style");o.id="ntf-css",o.textContent=`
