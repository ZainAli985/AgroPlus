import{a as c,j as t}from"./vendor-react-BFXNeceC.js";import{a as Q,A as K,S as H,N as _}from"./index-DAWI_HCx.js";import"./vendor-react-dom-DDWplefk.js";import"./vendor-DDAwBBib.js";const U="@import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=DM+Mono:wght@400;500&display=swap');",V=`
...
`,i=o=>isNaN(Number(o))?0:Number(o)||0,a=(o,f=2)=>i(o).toLocaleString("en-PK",{minimumFractionDigits:f,maximumFractionDigits:f}),x=o=>i(o).toLocaleString("en-PK",{minimumFractionDigits:0,maximumFractionDigits:0}),p=o=>i(o).toLocaleString("en-PK",{minimumFractionDigits:4,maximumFractionDigits:4}),T=["#374151","#15803d","#b45309","#1d4ed8","#7c3aed","#0e7490","#be185d","#dc2626"],Y=o=>T[o%T.length];function G(o,f,l){const z=o.map(d=>{const b=d.type==="purchase";return`<tr style="background:${b?"#f0fdf4":"#fef2f2"}">
      <td>${d.date}</td>
      ...
      <td style="text-align:right;font-weight:700;color:#15803d">Rs ${a(d.debit)}</td>
      <td style="text-align:right;font-weight:700;color:#dc2626">Rs ${a(d.credit)}</td>
...
<div class="sum">
  <div class="sb"><div class="sl">Stock In</div><div class="sv">Rs ${a(l.totalStockIn)}</div></div>
  <div class="sb"><div class="sl">Stock Out</div><div class="sv">Rs ${a(l.totalStockOut)}</div></div>
