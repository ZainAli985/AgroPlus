...
import { createSalesQuotation, deleteSalesQuotation, getAllSalesQuotations, getNextSalesQuotationSr, getSalesQuotationById } from "../controllers/saleQuotationController.js";
...
// ── Sales Quotations ──────────────────────────────────────────────────────────
// next-sr MUST be before /:id — prevent Express treating "next-sr" as an ObjectId.
router.get("/sales-quotation/next-sr", protect, getNextSalesQuotationSr);
router.post("/sales-quotation/create", protect, createSalesQuotation);
router.get("/sales-quotation", protect, getAllSalesQuotations);
router.get("/sales-quotation/:id", protect, getSalesQuotationById);
router.delete("/sales-quotation/:id", protect, deleteSalesQuotation);

// ── Sales Invoices ────────────────────────────────────────────────────────────
// next-sr MUST be before /:id
