...
//     height: 3px;
//     background: linear-gradient(90deg, #212A37 0%, #929183 45%, #A8A79F 55%, #212A37 100%);
//   }
...
//     position: absolute;
//     inset: 0;
//     background-image: radial-gradient(rgba(146,145,131,.05) 1px, transparent 1px);
...
//     border-radius: 10px;
//     border: 1px solid rgba(146,145,131,.22);
...
//     font-size: 14px; font-weight: 700; color: #929183;
//   }
...
//   .lg-desc {
//     font-size: 14px; color: rgba(165,168,166,.55);
...
//     font-size: 13px; color: rgba(165,168,166,.5); font-weight: 500;
//   }
//   .lg-feat-dot {
//     width: 5px; height: 5px; border-radius: 50%;
//     background: #929183; opacity: .55; flex-shrink: 0;
//   }
...
//     font-size: 10px; font-weight: 700;
//     letter-spacing: .2em; text-transform: uppercase;
//     color: #929183; margin-bottom: 7px;
...
//     background: #929183; border-radius: 2px; opacity: .7;
//   }

//   .lg-heading {
//     font-family: 'Cormorant Garamond', serif;
//     font-size: 32px; font-weight: 700; font-style: italic;
//     color: #0B0C0D; letter-spacing: -.4px; line-height: 1.1;
//     margin-bottom: 6px;
//   }
//   .lg-sub {
//     font-size: 13px; color: #A5A8A6;
...
//     text-transform: uppercase; color: #A5A8A6; margin-bottom: 8px;
//   }
//   .lg-lbl-bar { width: 14px; height: 2px; border-radius: 2px; background: #929183; opacity: .65; }

//   .lg-inp-wrap { position: relative; }
//   .lg-inp-icon {
//     position: absolute; left: 13px; top: 50%; transform: translateY(-50%);
//     color: #DADADA; pointer-events: none; display: flex;
//     transition: color .15s;
//   }
//   .lg-inp {
//     width: 100%; padding: 11px 14px 11px 40px;
//     border: 1.5px solid #E3E3E3; border-radius: 9px;
//     font-size: 13.5px; font-family: 'DM Sans', sans-serif;
//     color: #0B0C0D; background: #FAFAFA;
//     outline: none; transition: border-color .15s, background .12s, box-shadow .15s;
//   }
//   .lg-inp::placeholder { color: #DADADA; font-style: italic; }
//   .lg-inp:focus {
//     border-color: #212A37;
//     background: #fff;
//     box-shadow: 0 0 0 3px rgba(33,42,55,.07);
//   }
//   .lg-inp-wrap:focus-within .lg-inp-icon { color: #929183; }
...
//     background: #ECECEC; transition: background .14s, transform .1s;
//   }
//   .lg-seg.filled   { background: #929183; transform: scaleY(1.15); }
//   .lg-seg.complete { background: #22c55e; transform: scaleY(1.2); box-shadow: 0 0 6px rgba(34,197,94,.25); }
//   .lg-count {
//     font-family: 'DM Mono', monospace; font-size: 9.5px;
//     color: #DADADA; margin-left: 6px; flex-shrink: 0;
...
//     color: #DADADA; display: flex; padding: 3px; transition: color .12s;
//   }
//   .lg-eye:hover { color: #929183; }

//   /* submit */
//   .lg-btn {
//     width: 100%; padding: 12px;
//     border-radius: 9px; border: none; cursor: pointer;
//     background: #212A37; color: #fff;
//     font-size: 12.5px; font-weight: 700;
//     font-family: 'DM Sans', sans-serif;
//     letter-spacing: .07em; text-transform: uppercase;
//     display: flex; align-items: center; justify-content: center; gap: 8px;
//     margin-top: 4px;
//     box-shadow: 0 2px 10px rgba(33,42,55,.2);
//     transition: background .15s, box-shadow .15s, transform .1s;
//   }
//   .lg-btn:hover:not(:disabled) {
//     background: #141A1F;
//     box-shadow: 0 4px 18px rgba(33,42,55,.32);
...
//     letter-spacing: .14em; text-transform: uppercase; color: #DADADA;
//   }
//   .lg-form-foot-copy { font-size: 8.5px; color: #DADADA; }
...
//                   ))}
//                   <span className="lg-count" style={cnicDone ? {color:"#22c55e"} : {}}>
//                     {cnicDigits}/13
//                   </span>
//                 </div>
//               </div>
