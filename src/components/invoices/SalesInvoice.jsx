          ...
          <div className="inv-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, alignItems: "start" }}>
            ...
            <Panel title="Brokery & Summary" dot="#10b981">
              ...
              <div style={{ padding: "12px 14px", borderRadius: 10,
                background: "rgba(146,145,131,.05)", border: "1.5px solid rgba(146,145,131,.2)" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                  ...
                  <div style={{ height: 1, background: "rgba(146,145,131,.2)" }}/>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: "#929183",
                      textTransform: "uppercase", letterSpacing: ".06em" }}>Net Payable</span>
                    <span style={{ fontFamily: "'DM Mono',monospace",
                      fontSize: 17, fontWeight: 800, color: "#929183" }}>
