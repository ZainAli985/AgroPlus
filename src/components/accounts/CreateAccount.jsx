...
const CSS = `
  ...
  .ca2-search:focus { border-color: #212A37; box-shadow: 0 0 0 3px rgba(33,42,55,.1); }
  ...
  .ca2-type-btn:hover { border-color: #A5A8A6; color: #212A37; background: #f7f7f7; }
  ...
  .ca2-card:hover { border-color: #334455; box-shadow: 0 4px 12px rgba(33,42,55,.1); transform: translateY(-1px); }
  .ca2-card.selected { border-color: #212A37; background: #F5F5F5; box-shadow: 0 0 0 3px rgba(33,42,55,.1); }
  ...
  .ca2-inp:focus { border-color: #212A37; box-shadow: 0 0 0 3px rgba(33,42,55,.1); }
  ...
  .ca2-btn-primary:hover:not(:disabled) { background: #141A1F; }
