...
const CSS = `
  ...
  .sl-brand-role {
    ...
    text-transform: uppercase; color: rgba(212,168,67,.75);
    margin-top: 2px;
  }
  .sl-sidebar-close {
  ...
  .sl-menu-btn:hover { background: rgba(212,168,67,.1); color: #ffffff; backdrop-filter: blur(4px); }
  .sl-menu-btn.open  { background: rgba(78,122,46,.25); color: #F2C66D; border: 1px solid rgba(212,168,67,.25); }
  .sl-menu-icon {
  ...
  .sl-sub-link {
    ...
    color: rgba(255,255,255,.58); text-decoration: none; transition: all .12s;
    position: relative;
  }
  .sl-sub-link::before {
  ...
  .sl-sub-link:hover { background: rgba(212,168,67,.1); color: rgba(255,255,255,.95); }
  .sl-sub-link.active {
    background: rgba(78,122,46,.35); color: #F2C66D; font-weight: 700;
  ...
  .sl-direct-link {
    ...
    color: rgba(255,255,255,.72); text-decoration: none; transition: all .12s;
  }
  .sl-direct-link:hover { background: rgba(212,168,67,.1); color: #ffffff; text-decoration: none; }
  .sl-direct-link.active { background: rgba(78,122,46,.35); color: #F2C66D; font-weight: 700;
  ...
  .sl-user-role {
    ...
    text-transform: uppercase; color: rgba(212,168,67,.7); margin-top: 1px;
  }
  .sl-user-logout {
  ...
  .sl-topbar-title {
    ...
    color: #1A1F0E; letter-spacing: -.2px; font-style: italic;
    white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
    max-width: 320px;
  }
  ...
  .sl-company-name {
    font-size: 12.5px; font-weight: 700; color: #2F4F1F;
    letter-spacing: -.1px; white-space: nowrap;
  }

  /* welcome chip */
  .sl-welcome {
    font-size: 13px; color: #5C3A1A; font-weight: 500;
    white-space: nowrap;
  }
  .sl-welcome strong { color: #2F4F1F; font-weight: 700; }
              ...
              {profileOpen && (
                <div style={{
                  ...
                  <div style={{padding:"10px 14px 8px", borderBottom:"1px solid #f1f5f9"}}>
                    <div style={{fontSize:12.5, fontWeight:700, color:"#1A1F0E", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis"}}>{name}</div>
                  ...
                  {isAdmin && (
                    <button
                      ...
                      style={{
                        ...
                        textAlign:"left", fontSize:13, color:"#2F4F1F", cursor:"pointer",
